...
class CalendersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calender" do
    assert_difference('Calender.count') do
      post calenders_url, params: { calender: { name: @calender.name, start_time: @calender.start_time } }
    end
  ...
  test "should update calender" do
    patch calender_url(@calender), params: { calender: { name: @calender.name, start_time: @calender.start_time } }
